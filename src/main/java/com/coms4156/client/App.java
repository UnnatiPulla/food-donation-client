...
public class App implements CommandLineRunner {
    ...
    public void run(String... args) throws IOException {
        ...
        JsonObject responseaccount =
            userAuth.createAccountProfile(8, "RECIPIENT", "1234567890", "John Doe");
        System.out.println("Account created successfully! Account ID: " +
                           responseaccount.get("accountId").getAsString());
